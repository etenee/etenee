  ...
  var DataTable = function (_Component) {
    ...
    _createClass(DataTable, [{
      ...
      value: function componentWillMount() {
        ...
        var onInitialize = _props.onInitialize;
      ...
      value: function componentWillReceiveProps(nextProps) {
        ...
        var filterValue = _props2.filterValue;
        var onNewData = _props2.onNewData;
        var onNewFilterValue = _props2.onNewFilterValue;
      ...
      value: function render() {
        ...
        var isInitialized = _props3.isInitialized;
        var visibleRows = _props3.visibleRows;
        var filter = _props3.filter;
        var sortInfo = _props3.sortInfo;
        var pageInfo = _props3.pageInfo;
        var selectAll = _props3.selectAll;
        var selectedRows = _props3.selectedRows;
        var primaryKey = _props3.primaryKey;
        var filterOptions = _props3.filterOptions;
        var data = _props3.data;
        var _onPageChange = _props3.onPageChange;
        var onPageSizeChange = _props3.onPageSizeChange;
        var onFilterChange = _props3.onFilterChange;
        var onFilterTextChange = _props3.onFilterTextChange;
        var onHeaderClick = _props3.onHeaderClick;
        var onRowCheckedChange = _props3.onRowCheckedChange;
        var onSelectAllChange = _props3.onSelectAllChange;

        var otherProps = _objectWithoutProperties(_props3, ['isInitialized', 'visibleRows', 'filter', 'sortInfo', 'pageInfo', 'selectAll', 'selectedRows', 'primaryKey', 'filterOptions', 'data', 'onPageChange', 'onPageSizeChange', 'onFilterChange', 'onFilterTextChange', 'onHeaderClick', 'onRowCheckedChange', 'onSelectAllChange']);

        var _configs$showPageSize = configs.showPageSize;
        var showPageSize = _configs$showPageSize === undefined ? true : _configs$showPageSize;
        var _configs$showFilter = configs.showFilter;
        var showFilter = _configs$showFilter === undefined ? true : _configs$showFilter;
        var _configs$autoHidePagi = configs.autoHidePagination;
        var autoHidePagination = _configs$autoHidePagi === undefined ? true : _configs$autoHidePagi;
        var _configs$pageSizeCont = configs.pageSizeContainerClassName;
        var pageSizeContainerClassName = _configs$pageSizeCont === undefined ? 'col-md-6' : _configs$pageSizeCont;
        var _configs$filterContai = configs.filterContainerClassName;
        var filterContainerClassName = _configs$filterContai === undefined ? 'col-md-6' : _configs$filterContai;
        var pageSizeClassName = configs.pageSizeClassName;
        var filterClassName = configs.filterClassName;
